        ...
        <div>
            <section className="relative">
                ...
                <div className="absolute inset-0 flex justify-center items-center">
                    <div className="text-center mx-auto max-w-lg px-1 text-[#DCCA87]">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold">Crush your health and fitness goals in no time</h1>
                        <p className="mt-5 text-lg text-[#FFFFFF]">It doesn’t matter if your goal is to get stronger, burn fat, or to just stay fit our world class coaches will guide you every step of the way.</p>
